...
const goToOverview = () => {
  router.push({ name: 'Overview: Account Info' });
};
</script>
    ...
    <template v-if="!paymentModal || windowInnerWidth > 768">
      <div class="page-info">
        <h1 class="page-heading">
          Saved Payment Method(s)<span class="optional">(optional)</span>
        </h1>
        <p class="page-description">
          Add one or more payment methods to speed up the checkout process. You
          can also add them during checkout or later in your account overview.
        </p>
      </div>
      ...
      <button class="btn-accent-1 btn-submit" @click="goToOverview">
