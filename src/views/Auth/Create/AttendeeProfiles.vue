...
const openAtendeeModal = (type, attendee) => {
  attendeeModal.value.modal = true;
  attendeeModal.value.type = type;
  if (attendee.owner) {
    attendeeModal.value.accountOwner = true;
  }
};
...
const closeAttendeeModal = () => {
  ...
  attendeeModal.value.accountOwner = false;
};
...
const NextStep = () => {
  router.push({ name: 'Create: Payment Methods' });
};
</script>

<template>
  <section class="attendee-profiles">
    <template v-if="!attendeeModal.modal || windowInnerWidth > 768">
      <div class="page-info">
        <h1 class="page-heading">
          Saved Attendee Profile(s)<span class="optional">(optional)</span>
        </h1>
        <p class="page-description">
          If there're other class attendees in your household, you can create a
          profile for them here to speed up the checkout process. You can also
          add them during checkout or later in your account overview.
        </p>
      </div>
        ...
        >
          <header>
            ...
            <div class="actions">
              <button
                class="edit-card"
                @click="openAtendeeModal('edit', attendee)"
              >
      ...
      <button class="btn-accent-1 btn-submit" @click="NextStep">Next</button>
    </template>
          ...
          <div class="row">
            <div class="column">
              ...
              <label
                ...
                v-if="!attendeeModal.accountOwner"
              >
                <input type="checkbox" />
